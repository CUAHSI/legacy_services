...
namespace WaterOneFlowImpl
{
    ...
    public class Logging
    {
        ...
        const string failedCode = "_Failed";
        ...
        public void LogValuesFailed(Methods Method, string Location, string Variable, string start, string end, long ProcessingTime, int Count, string UserHost)
        {
            LogQueryFormatted(
                Method.ToString() + failedCode,
                Location,
                Variable,
                start,
                end,
