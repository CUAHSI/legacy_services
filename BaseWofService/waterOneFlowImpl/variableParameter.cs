...
namespace WaterOneFlowImpl
{
    ...
    public class VariableParam
    {
        ...
        public String Code
        {
            ...
            set
            {
                this.CodeField = WaterOneFlow.Utilities.Service.Text.CodeField.Encode( value);
            }
        }
        ...
        /// LRemoves the 
        /// </summary>
        public String OrignalCodeNoVocabulary
        {
            get
            {
                String[] s = variableOriginal.Split(sep.ToCharArray(),2);
                return s[1].Trim();
