...
namespace WaterOneFlow.Service
{
    namespace Response
    {
       ...
       ElementName = "variablesResponse")]
            public class VariablesResponseType : Abstract.VariablesResponseType, IXmlSerializable
            {
               ...
               //   private const string TypeName = "variablesResponse";
                ...
                public static XmlQualifiedName WaterMLSchema(XmlSchemaSet xs)
                {
                    ...
                    return new XmlQualifiedName(TypeName, WaterOneFlow.Service.Constants.v1.ServiceDescriptions.XML_SCHEMA_NAMSPACE);
                }
          ...
          //  [XmlRoot(ElementName = "sitesResponse", Namespace = Constants.v1.ServiceDescriptions.XML_SCHEMA_NAMSPACE)]
            public class SiteInfoResponseType : Abstract.SiteInfoResponseType, IXmlSerializable
            {
         ...
         //   [XmlRoot(ElementName = "timeSeriesResponse", Namespace = Constants.v1.ServiceDescriptions.XML_SCHEMA_NAMSPACE)]
            public class TimeSeriesResponseType : Abstract.TimeSeriesResponseType, IXmlSerializable
            {
                // used in the schema method
            ...
            public class GetSchemaResource
        {
            ...
            {
                    return WaterOneFlow.Schema.GetSchema.SchemaV1_0();
