       ...
       public  static XmlReader SitesByCountryXmlReaderXMLOutput(String DatasetID, String Country, String Token)
        {
           ...
           return Utility.RestByUrl(Url, Properties.Settings.Default.XmlOutputFormat, Token);
       }
        ...
        public static XmlReader SitesByCountryXmlReaderWaterMLOutput(String DatasetID, String Country, String Token)
        {
            ...
            return Utility.RestByUrl(Url, Properties.Settings.Default.WaterMLOuputFormat, Token);
        }
        ...
        {
            return String.Format(Properties.Settings.Default.SitesCountryPath, datasetCode, Country);
        }

        private static string UrlPathByState(string DatasetCode, String State)
        {
            return String.Format(Properties.Settings.Default.SitesStatePath, DatasetCode, State);
        }
   }
