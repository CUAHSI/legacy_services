...
namespace WaterOneFlow.Service
{
    ...
    //    public class Service_1_0 : WebService, IService_1_0
        public class Service_1_0 : WebService, IWaterOneFlowWebService
        {
            ...
            protected DataInfoService ODws;
  ...
  ElementName = "sitesResponse", IsNullable = false
            ...
            [WebMethod(Description = WsDescriptions.GetSitesDefaultDesc)]
            public  object GetSites(string[] site, String authToken)
            {
...
ElementName = "variablesResponse", IsNullable = false
            ...
            public  object GetVariableInfoObject(string variable, String authToken)
            {
                ...
                try
                {
                    ...
                    VariablesResponseType res = new VariablesResponseType();
                       res.variables = ODws.GetVariableInfoObject(vars);
                    res.queryInfo = new QueryInfoType();
                    res.queryInfo.creationTime = DateTime.Now;
                    res.queryInfo.creationTimeSpecified = true;
                    res.queryInfo.criteria = new QueryInfoTypeCriteria();
                    res.queryInfo.criteria.variableParam = variable;
...
ElementName = "timeSeriesResponse",
            ...
            public  object GetValuesObject(string location, string variable, string startDate, string endDate, String authToken)
            {
                ...
                try
                {
                    ...
                    //return res;
                    int count;
                    if (res.timeSeries.values != null && 
                        res.timeSeries.values.value != null)
                    {
                        count = res.timeSeries.values.value.Length;
                    }
                    else
                    {
                        count = 0;
                ...
                {
                    log.Warn(we.Message);
                    queryLog2.LogValuesFailed(Logging.Methods.GetValues,
                                location, //locaiton
                                variable, //variable
                                startDate, // startdate
                                startDate, //enddate
