...
namespace EPAWOFService.Epa.StoretResultsService {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="StoretResultServicePortBinding", Namespace="http://storetresultservice.storet.epa.gov/")]
    public partial class StoretResultService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public StoretResultService() {
            this.Url = global::EPAWOFService.Properties.Settings.Default.EPAWOFService_Epa_StoretResultsService_StoretResultService;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("", RequestNamespace="http://storetresultservice.storet.epa.gov/", ResponseNamespace="http://storetresultservice.storet.epa.gov/", Use=System.Web.Services.Description.SoapBindingUse.Literal)]
        [return: System.Xml.Serialization.XmlElementAttribute("return")]
        public string getResults(string OrganizationId, string MonitoringLocationId, string MonitoringLocationType, string MinimumActivityStartDate, string MaximumActivityStartDate, string MinimumLatitude, string MaximumLatitude, string MinimumLongitude, string MaximumLongitude, string CharacteristicType, string CharacteristicName, string ResultType) {
