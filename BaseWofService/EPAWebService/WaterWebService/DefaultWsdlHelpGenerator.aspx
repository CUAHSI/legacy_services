  ...
  <head>
	...
	<script language="javascript">
		function ShowTestSection() {
			document.all.soaptemplaterequest.style.display = "block";
			document.all.soapsamplerequest.style.display = "none";
			document.all.soapsampleresponse.style.display = "none";
			document.all.testhref.style.display = "none";
			document.all.samplehref.style.display = "block";
			document.all.soapsampletitle.style.display = "none";
			document.all.soaptesttitle.style.display = "block";
		}
		
		function ShowTemplateSection() {
			document.all.soaptemplaterequest.style.display = "none";
			document.all.soapsamplerequest.style.display = "block";
			document.all.soapsampleresponse.style.display = "block";
			document.all.samplehref.style.display = "none";
			document.all.testhref.style.display = "block";
			document.all.soapsampletitle.style.display = "block";
			document.all.soaptesttitle.style.display = "none";
		}
		...
		function SendSoapRequest_onclick(SoapRequest, MethodName, Url) {
			...
			document.all.tempsoaprequest.value = document.all.txasoaptemplaterequest.innerText;
			document.all.txasoaptemplaterequest.innerText = xmlhttp.responseXML.xml;
			document.all.backhref.style.display = "block";
			document.all.posthref.style.display = "none";
		}

		function GoBackToRequest_onclick() {
			document.all.txasoaptemplaterequest.innerText = document.all.tempsoaprequest.value;
			document.all.backhref.style.display = "none";
			document.all.posthref.style.display = "block";
		}
	</script>
</head>
...
<div id="content">
	...
	<span visible='<%#!ShowingMethodList &&	OperationExists%>' runat=server ID="Span3">
		...
		<span visible='<%#ShowingSoap%>' runat=server ID="Span4">
			<h3	id="testhref">
				<a href="javascript:ShowTestSection();">Test this	call...</a>
			</h3>
			<h3	id="samplehref"	style="display=none;"><a href="javascript:ShowTemplateSection();">Show sample request/response...</a></h3>
			<p id="soaptesttitle" style="display=none;">&nbsp;</p>
			<p id="soapsampletitle"><%#GetLocalizedText("SoapText")%></p>
			<pre id="soaptemplaterequest" style="display:none;"><form><textarea	name="txasoaptemplaterequest" style="background-color:#e5e5cc;width:expression(document.all.soapsamplerequest.clientWidth +	12);height:expression(document.all.soapsamplerequest.clientHeight +	12);"><%#SoapOperationInput2%></textarea>
			<div id="posthref" style="font-size:1.1em;color:#000000;margin-top:10px;margin-bottom:10px;"><a	href="javascript:SendSoapRequest_onclick(document.all.txasoaptemplaterequest.innerText,	'<%#OperationName%>', '<%=Request.FilePath%>');"	/>Post template...</a></div>
<div id="note" style="font-size:0.8em;color:#000000;margin-top:10px;margin-bottom:10px;">
<BR><BR>NOTE: MSXML4 must be installed in order to test the web service successfully.
<BR>If you receive JavaScript errors due to not having MSXML4 installed, 
<BR>you can download it <a href="http://www.microsoft.com/downloads/details.aspx?familyid=3144B72B-B4F2-46DA-B4B6-C5D7485F2B42&displaylang=en" target="_new">here</a>.
<BR>
</div><div id="backhref" style="display:none;font-size:1.1em;color:#000000;margin-top:10px;margin-bottom:10px;"><a href="javascript:GoBackToRequest_onclick();" />GO back to request template...</a><br /></div><input id="tempsoaprequest" type="hidden"	/></form></pre>
			<pre id="soapsamplerequest"	style="width:10;"><%#SoapOperationInput%></pre>
			<pre id="soapsampleresponse" ><%#SoapOperationOutput%></pre>
		</span>
	</span>
