...
{
	/// <summary>
	/// 	This class represents the ComplexType options
	/// </summary>
	[LiquidTechnologies.Runtime.Net20.XmlObjectInfo(LiquidTechnologies.Runtime.Net20.XmlObjectBase.XmlElementGroupType.Sequence,
													...
													"options", "", true, false)]
	public partial class Options : cuahsiTimeSeries_v1_0Lib.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		...
		public Options()
		{
			_elementName = "options";
			Init();
		}
		public Options(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			cuahsiTimeSeries_v1_0Lib.Options newObject = new cuahsiTimeSeries_v1_0Lib.Options(_elementName);
