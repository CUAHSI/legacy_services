...
{
	/// <summary>
	/// 	This class represents the ComplexType SourceInfoType
	/// </summary>
	[LiquidTechnologies.Runtime.Net20.XmlObjectInfo(LiquidTechnologies.Runtime.Net20.XmlObjectBase.XmlElementGroupType.Sequence,
													...
													"SourceInfoType", "http://www.cuahsi.org/waterML/1.0/", true, true)]
	public partial class SourceInfoType : cuahsiTimeSeries_v1_0Lib.XmlCommonBase
					, tns.ISourceInfoType
	{
		#region Constructors
		/// <summary>
		///		Constructor for SourceInfoType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "SourceInfoType";
			Init();
		}
		public SourceInfoType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			tns.SourceInfoType newObject = new tns.SourceInfoType(_elementName);
