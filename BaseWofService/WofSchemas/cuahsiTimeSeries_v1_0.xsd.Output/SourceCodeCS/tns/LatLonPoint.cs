...
{
	/// <summary>
	/// 	This class represents the Element latLonPoint
	/// </summary>
	[LiquidTechnologies.Runtime.Net20.XmlObjectInfo(LiquidTechnologies.Runtime.Net20.XmlObjectBase.XmlElementGroupType.Sequence,
													...
													"latLonPoint", "http://www.cuahsi.org/waterML/1.0/", true, true)]
	public partial class LatLonPoint : cuahsiTimeSeries_v1_0Lib.XmlCommonBase
					, tns.IGeogLocationType
	{
		...
		public LatLonPoint()
		{
			_elementName = "latLonPoint";
			Init();
		}
		public LatLonPoint(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			tns.LatLonPoint newObject = new tns.LatLonPoint(_elementName);
