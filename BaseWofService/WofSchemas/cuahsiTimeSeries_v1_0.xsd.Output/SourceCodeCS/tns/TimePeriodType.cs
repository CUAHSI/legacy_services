...
{
	/// <summary>
	/// 	This class represents the ComplexType TimePeriodType
	/// </summary>
	[LiquidTechnologies.Runtime.Net20.XmlObjectInfo(LiquidTechnologies.Runtime.Net20.XmlObjectBase.XmlElementGroupType.Sequence,
													...
													"TimePeriodType", "http://www.cuahsi.org/waterML/1.0/", true, true)]
	public partial class TimePeriodType : cuahsiTimeSeries_v1_0Lib.XmlCommonBase
					, tns.ITimePeriodType
	{
		#region Constructors
		/// <summary>
		///		Constructor for TimePeriodType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "TimePeriodType";
			Init();
		}
		public TimePeriodType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			tns.TimePeriodType newObject = new tns.TimePeriodType(_elementName);
