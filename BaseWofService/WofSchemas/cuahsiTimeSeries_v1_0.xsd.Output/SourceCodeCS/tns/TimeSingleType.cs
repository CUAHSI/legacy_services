...
{
	/// <summary>
	/// 	This class represents the ComplexType TimeSingleType
	/// </summary>
	[LiquidTechnologies.Runtime.Net20.XmlObjectInfo(LiquidTechnologies.Runtime.Net20.XmlObjectBase.XmlElementGroupType.Sequence,
													...
													"TimeSingleType", "http://www.cuahsi.org/waterML/1.0/", true, true)]
	public partial class TimeSingleType : cuahsiTimeSeries_v1_0Lib.XmlCommonBase
					, tns.ITimePeriodType
	{
		#region Constructors
		/// <summary>
		///		Constructor for TimeSingleType
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public TimeSingleType()
		{
			_elementName = "TimeSingleType";
			Init();
		}
		public TimeSingleType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_TimeSingle = new LiquidTechnologies.Runtime.Net20.XmlDateTime(LiquidTechnologies.Runtime.Net20.XmlDateTime.DateType.dateTime);
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			tns.TimeSingleType newObject = new tns.TimeSingleType(_elementName);
			newObject.m_TimeSingle = (LiquidTechnologies.Runtime.Net20.XmlDateTime)m_TimeSingle.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net20.ElementInfoSeqPrimMnd("timeSingle", "http://www.cuahsi.org/waterML/1.0/", LiquidTechnologies.Runtime.Net20.Conversions.ConversionType.type_datetime, null, LiquidTechnologies.Runtime.Net20.WhitespaceUtils.WhitespaceRule.Collapse, "", -1, -1, "", "", "", "", -1)]
		public LiquidTechnologies.Runtime.Net20.XmlDateTime TimeSingle
		{
			get 
			{ 
				return m_TimeSingle;  
			...
			set 
			{ 
				m_TimeSingle.SetDateTime(value, m_TimeSingle.Type); 
			}
		}
		protected LiquidTechnologies.Runtime.Net20.XmlDateTime m_TimeSingle;
