...
{
	/// <summary>
	/// 	This class represents the ComplexType GeogLocationType
	/// </summary>
	[LiquidTechnologies.Runtime.Net20.XmlObjectInfo(LiquidTechnologies.Runtime.Net20.XmlObjectBase.XmlElementGroupType.Sequence,
													...
													"GeogLocationType", "http://www.cuahsi.org/waterML/1.0/", true, true)]
	public partial class GeogLocationType : cuahsiTimeSeries_v1_0Lib.XmlCommonBase
					, tns.IGeogLocationType
	{
		#region Constructors
		/// <summary>
		///		Constructor for GeogLocationType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "GeogLocationType";
			Init();
		}
		public GeogLocationType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			tns.GeogLocationType newObject = new tns.GeogLocationType(_elementName);
