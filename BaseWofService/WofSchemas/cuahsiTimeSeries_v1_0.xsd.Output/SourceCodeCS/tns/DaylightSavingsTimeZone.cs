...
{
	/// <summary>
	/// 	This class represents the ComplexType daylightSavingsTimeZone
	/// </summary>
	[LiquidTechnologies.Runtime.Net20.XmlObjectInfo(LiquidTechnologies.Runtime.Net20.XmlObjectBase.XmlElementGroupType.Sequence,
													...
													"daylightSavingsTimeZone", "http://www.cuahsi.org/waterML/1.0/", true, false)]
	public partial class DaylightSavingsTimeZone : cuahsiTimeSeries_v1_0Lib.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for DaylightSavingsTimeZone
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public DaylightSavingsTimeZone()
		{
			_elementName = "daylightSavingsTimeZone";
			Init();
		}
		public DaylightSavingsTimeZone(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			tns.DaylightSavingsTimeZone newObject = new tns.DaylightSavingsTimeZone(_elementName);
