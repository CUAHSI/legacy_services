...
{
	/// <summary>
	/// 	This class represents the ComplexType LatLonBoxType
	/// </summary>
	[LiquidTechnologies.Runtime.Net20.XmlObjectInfo(LiquidTechnologies.Runtime.Net20.XmlObjectBase.XmlElementGroupType.Sequence,
													...
													"LatLonBoxType", "http://www.cuahsi.org/waterML/1.0/", true, true)]
	public partial class LatLonBoxType : cuahsiTimeSeries_v1_0Lib.XmlCommonBase
					, tns.IGeogLocationType
	{
		#region Constructors
		/// <summary>
		///		Constructor for LatLonBoxType
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "LatLonBoxType";
			Init();
		}
		public LatLonBoxType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			tns.LatLonBoxType newObject = new tns.LatLonBoxType(_elementName);
