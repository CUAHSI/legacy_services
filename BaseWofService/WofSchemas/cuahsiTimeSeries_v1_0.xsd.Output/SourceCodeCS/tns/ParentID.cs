...
{
	/// <summary>
	/// 	This class represents the ComplexType parentID
	/// </summary>
	[LiquidTechnologies.Runtime.Net20.XmlObjectInfo(LiquidTechnologies.Runtime.Net20.XmlObjectBase.XmlElementGroupType.Sequence,
													...
													"parentID", "http://www.cuahsi.org/waterML/1.0/", true, false)]
	public partial class ParentID : cuahsiTimeSeries_v1_0Lib.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for ParentID
		/// </summary>
		/// <remarks>
		...
		public ParentID()
		{
			_elementName = "parentID";
			Init();
		}
		public ParentID(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			tns.ParentID newObject = new tns.ParentID(_elementName);
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		/// </summary>
		/// <remarks>
		/// 	This class represents the element ParentID, this
		/// 	element is open, and as such we can place data into it.
		/// 	<BR>ie &lt;ParentID&gt;Some Data&lt;/ParentID&gt;</BR>
		/// </remarks>
		public String Text
		{
			get
