...
{
	/// <summary>
	/// 	This class represents the ComplexType DataSetInfoType
	/// </summary>
	[LiquidTechnologies.Runtime.Net20.XmlObjectInfo(LiquidTechnologies.Runtime.Net20.XmlObjectBase.XmlElementGroupType.Sequence,
													...
													"DataSetInfoType", "http://www.cuahsi.org/waterML/1.0/", true, true)]
	public partial class DataSetInfoType : cuahsiTimeSeries_v1_0Lib.XmlCommonBase
					, tns.ISourceInfoType
	{
		#region Constructors
		/// <summary>
		///		Constructor for DataSetInfoType
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public DataSetInfoType()
		{
			_elementName = "DataSetInfoType";
			Init();
		}
		public DataSetInfoType(String elementName)
		{
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			tns.DataSetInfoType newObject = new tns.DataSetInfoType(_elementName);
