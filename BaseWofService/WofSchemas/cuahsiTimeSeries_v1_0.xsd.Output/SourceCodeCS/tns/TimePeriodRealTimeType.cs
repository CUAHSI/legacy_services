...
{
	/// <summary>
	/// 	This class represents the ComplexType TimePeriodRealTimeType
	/// </summary>
	[LiquidTechnologies.Runtime.Net20.XmlObjectInfo(LiquidTechnologies.Runtime.Net20.XmlObjectBase.XmlElementGroupType.Sequence,
													...
													"TimePeriodRealTimeType", "http://www.cuahsi.org/waterML/1.0/", true, true)]
	public partial class TimePeriodRealTimeType : cuahsiTimeSeries_v1_0Lib.XmlCommonBase
					, tns.ITimePeriodType
	{
		#region Constructors
		/// <summary>
		///		Constructor for TimePeriodRealTimeType
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public TimePeriodRealTimeType()
		{
			_elementName = "TimePeriodRealTimeType";
			Init();
		}
		public TimePeriodRealTimeType(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_RealTimeDataPeriod = new LiquidTechnologies.Runtime.Net20.XmlDateTimeSpan();
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			tns.TimePeriodRealTimeType newObject = new tns.TimePeriodRealTimeType(_elementName);
			newObject.m_RealTimeDataPeriod = (LiquidTechnologies.Runtime.Net20.XmlDateTimeSpan)m_RealTimeDataPeriod.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#region Attribute - realTimeDataPeriod
		/// <summary>
		...
		///		<BR>It is defaulted to new LiquidTechnologies.Runtime.Net20.XmlDateTimeSpan().</BR>
		/// </remarks>
        [LiquidTechnologies.Runtime.Net20.ElementInfoSeqPrimMnd("realTimeDataPeriod", "http://www.cuahsi.org/waterML/1.0/", LiquidTechnologies.Runtime.Net20.Conversions.ConversionType.type_duration, null, LiquidTechnologies.Runtime.Net20.WhitespaceUtils.WhitespaceRule.Collapse, "", -1, -1, "", "", "", "", -1)]
		public LiquidTechnologies.Runtime.Net20.XmlDateTimeSpan RealTimeDataPeriod
		{
			get 
			{ 
			...
			set 
			{ 
				m_RealTimeDataPeriod = value;
			}
		}
		protected LiquidTechnologies.Runtime.Net20.XmlDateTimeSpan m_RealTimeDataPeriod;
