...
{
	/// <summary>
	/// 	This class represents the Element sitesResponse
	/// </summary>
	[LiquidTechnologies.Runtime.Net20.XmlObjectInfo(LiquidTechnologies.Runtime.Net20.XmlObjectBase.XmlElementGroupType.Sequence,
													...
													"sitesResponse", "http://www.cuahsi.org/waterML/1.0/", true, false)]
	public partial class SitesResponse : cuahsiTimeSeries_v1_0Lib.XmlCommonBase
	{
		#region Constructors
		/// <summary>
		///		Constructor for SitesResponse
		/// </summary>
		/// <remarks>
		...
		{
			_elementName = "sitesResponse";
			Init();
		}
		public SitesResponse(String elementName)
		{
		...
		protected override void Init()
		{
			...
			m_QueryInfo = null;
			m_Site = new cuahsiTimeSeries_v1_0Lib.XmlObjectCollection<cuahsiTimeSeries_v1_0Lib.Site>("site", "http://www.cuahsi.org/waterML/1.0/", 0, -1, false);
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		{
			tns.SitesResponse newObject = new tns.SitesResponse(_elementName);
			newObject.m_QueryInfo = null;
			if (m_QueryInfo != null)
				newObject.m_QueryInfo = (tns.QueryInfoType)m_QueryInfo.Clone();
			foreach (cuahsiTimeSeries_v1_0Lib.Site o in m_Site)
				newObject.m_Site.Add((cuahsiTimeSeries_v1_0Lib.Site)o.Clone());
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
		...
		#endregion
		#region Attribute - site
		/// <summary>
		/// 	A collection of site's
		///		
		/// </summary>
		/// <remarks>
		/// 	<BR></BR>
		...
		/// </remarks>
        [LiquidTechnologies.Runtime.Net20.ElementInfoSeqClsCol("site", "http://www.cuahsi.org/waterML/1.0/", LiquidTechnologies.Runtime.Net20.XmlObjectBase.XmlElementType.Element)]
		public cuahsiTimeSeries_v1_0Lib.XmlObjectCollection<cuahsiTimeSeries_v1_0Lib.Site> Site
		{
			get { return m_Site; }
		}
		protected cuahsiTimeSeries_v1_0Lib.XmlObjectCollection<cuahsiTimeSeries_v1_0Lib.Site> m_Site;
