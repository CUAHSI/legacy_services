...
namespace WaterOneFlow.odm.v1_1.siteInfoDataSetTableAdapters {
    ...
    public partial class sitesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT Comments, County, Elevation_m, LatLongDatumID, Latitude, LocalProjectionID" +
    ...
    public partial class SpatialReferencesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [SpatialReferences] ([SRSID], [SRSName], [IsGeographic], [Notes]) VALUES (@SRSID, @SRSName, @IsGeographic, @Notes);
SELECT SpatialReferenceID, SRSID, SRSName, IsGeographic, Notes FROM SpatialReferences WHERE (SpatialReferenceID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [SpatialReferences] SET [SRSID] = @SRSID, [SRSName] = @SRSName, [IsGeographic] = @IsGeographic, [Notes] = @Notes WHERE (([SpatialReferenceID] = @Original_SpatialReferenceID));
SELECT SpatialReferenceID, SRSID, SRSName, IsGeographic, Notes FROM SpatialReferences WHERE (SpatialReferenceID = @SpatialReferenceID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT     SpatialReferences.*\r\nFROM         SpatialReferences";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
