...
namespace NwisWOFService
{
    namespace v1_0
    {
        ...
        public class GetValuesUnitRestUSGS : DataTimeSeriesWofService
        {
            /*
    ...
    #   *20   00095     00003   - Specific conductance, water, unfiltered, microsiemens per centimeter at 25 degrees Celsius (Mean)
            ...
            public GetValuesUnitRestUSGS(string BaseRestUrl)
                : base()
            {
            ...
            public GetValuesUnitRestUSGS(string BaseRestUrl, int MaximumRequestDays)
                : base()
            {
                USGSUVBaseUrl = BaseRestUrl;
                maxRequestDays = MaximumRequestDays;
                InitializeService();
