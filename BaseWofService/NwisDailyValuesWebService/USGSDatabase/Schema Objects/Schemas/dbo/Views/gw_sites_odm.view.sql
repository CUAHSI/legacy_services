...
SELECT     sites.site_no AS SiteID, CASE WHEN sites.agency_cd = 'USGS' THEN sites.site_no ELSE sites.site_no + '/agency=' + sites.agency_cd END AS SiteCode, 
                      ...
                      sites.county_cd AS Usgs_County_fipsCode, sites.agency_cd AS usgs_agency, 'NWISGW' AS SiteVocabulary, 'NWISGW:' + sites.site_no AS hs_SiteCode, 
...
FROM         dbo.USGS_sitefile AS sites INNER JOIN
                          (SELECT DISTINCT site_no, agency_cd
                            FROM          dbo.series
                            WHERE      (data_type_cd = 'gw')) AS sitesUsed ON sites.site_no = sitesUsed.site_no AND sites.agency_cd = sitesUsed.agency_cd LEFT OUTER JOIN
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[35] 4[25] 2[22] 3) )"
      End
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         ...
         Or = 1350
         Or = 1350
         Or =', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'gw_sites_odm';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'1350
      End
   End
End', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'gw_sites_odm';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'gw_sites_odm';
