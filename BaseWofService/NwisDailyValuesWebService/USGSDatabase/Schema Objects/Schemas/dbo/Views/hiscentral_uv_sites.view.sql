CREATE VIEW dbo.hiscentral_uv_sites
AS
SELECT     CONVERT(nvarchar(101), SiteVocabulary + ':' + SiteCode) AS SiteCode, CONVERT(nvarchar(200), SiteName) AS SiteName, Latitude, Longitude, CONVERT(varchar(150), 
                      ...
                      AS HUCnumeric, 3 AS NetworkID
FROM         dbo.odm_uv_sites AS sites
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      ...
      End
   End
End', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'hiscentral_uv_sites';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'hiscentral_uv_sites';
