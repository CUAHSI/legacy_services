CREATE VIEW [dbo].[qw_series_static]
AS
SELECT     sitePOR.site_no AS siteID, CASE WHEN sitePOR.agency_cd = 'USGS' THEN sitePOR.site_no ELSE sitePOR.site_no + '/agency=' + sitePOR.agency_cd END AS SiteCode,
                      ...
                      'NWISWQ' AS VariableVocabulary, 'NWIS:' + variableView.VariableCode AS hs_variableCode, 'NWIS:' + sitePOR.site_no AS hs_siteCode, 
...
FROM         dbo.series_qw AS sitePOR INNER JOIN
                      dbo.odm_qw_variables AS variableView ON sitePOR.parm_cd = variableView.parm_cd
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[35] 4[19] 2[27] 3) )"
      End
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         ...
         NewValue = 1170
         SortType = 1350
         SortOrder = 14', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'qw_series_static';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'10
         GroupBy = 1350
         Filter = 1350
         Or = 1350
         Or = 1350
      ...
      End
   End
End', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'qw_series_static';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'qw_series_static';
