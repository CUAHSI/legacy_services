...
CREATE VIEW [dbo].[hiscentral_gw_variables]
AS
SELECT     CONVERT(nvarchar(100), VariableName) AS Variable, VariableUnitsID AS UnitID, CONVERT(nvarchar(50), SampleMedium) AS SampleMedium, CONVERT(nvarchar(50), 
                      ...
                      AS AltVariableName, CONVERT(nvarchar(100), VariableUnitsAbbreviation) AS AltUnits, 8 AS networkId
FROM         dbo.odm_gw_variables AS vars
