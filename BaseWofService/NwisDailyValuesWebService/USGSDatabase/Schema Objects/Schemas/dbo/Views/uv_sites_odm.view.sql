...
SELECT     sites.site_no AS SiteID, CASE WHEN sites.agency_cd = 'USGS' THEN sites.site_no ELSE sites.site_no + '/agency=' + sites.agency_cd END AS SiteCode, 
                      ...
                      sites.county_cd AS Usgs_County_fipsCode, sites.agency_cd AS usgs_agency, 'NWISUV' AS SiteVocabulary, 'NWISUV:' + sites.site_no AS hs_SiteCode, 
...
FROM         dbo.USGS_sitefile AS sites INNER JOIN
                          (SELECT DISTINCT site_no, agency_cd
                            FROM          dbo.series
                            WHERE      (data_type_cd = 'uv')) AS sitesUsed ON sites.site_no = sitesUsed.site_no LEFT OUTER JOIN
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[29] 4[30] 2[17] 3) )"
      End
   ...
   End
   Begin CriteriaPane = 
      Begin ColumnWidths =', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'uv_sites_odm';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'11
      ...
      End
   End
End', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'uv_sites_odm';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'uv_sites_odm';
