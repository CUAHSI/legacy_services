CREATE VIEW dbo.hiscentral_gw_series
AS
SELECT     CONVERT(varchar(101), SiteVocabulary + ':' + SiteCode) AS SiteCode, CONVERT(varchar(200), siteName) AS SiteName, CONVERT(varchar(20), VariableCode) 
                      ...
                      ValueCount, NULL AS GeneralCategory, NULL AS UTCOffset, 8 AS SourceID, CONVERT(nvarchar(100), VariableVocabulary + ':' + VariableCode) AS VariableCode, 
                      CONVERT(nvarchar(255), SiteVocabulary + ':' + SiteCode + '|' + VariableVocabulary + ':' + VariableCode) AS SeriesCode
FROM         dbo.odm_gw_series
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      ...
      End
   End
End', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'hiscentral_gw_series';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'hiscentral_gw_series';
