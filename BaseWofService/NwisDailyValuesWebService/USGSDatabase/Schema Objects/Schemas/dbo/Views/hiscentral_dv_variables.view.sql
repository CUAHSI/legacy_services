...
CREATE VIEW [dbo].[hiscentral_dv_variables]
AS
SELECT     CONVERT(nvarchar(100), VariableName) AS Variable, VariableUnitsID AS UnitID, CONVERT(nvarchar(50), SampleMedium) AS SampleMedium, CONVERT(nvarchar(50), 
                      ...
                      AS AltVariableName, CONVERT(nvarchar(100), VariableUnitsAbbreviation) AS AltUnits, 1 AS networkId
FROM         dbo.odm_dv_variables AS vars
