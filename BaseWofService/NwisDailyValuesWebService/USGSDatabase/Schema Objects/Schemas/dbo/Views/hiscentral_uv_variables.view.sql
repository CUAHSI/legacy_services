CREATE VIEW dbo.hiscentral_uv_variables
AS
SELECT     CONVERT(nvarchar(100), VariableName) AS Variable, VariableUnitsID AS UnitID, CONVERT(nvarchar(50), SampleMedium) AS SampleMedium, CONVERT(nvarchar(50), 
                      ...
                      AS AltVariableName, CONVERT(nvarchar(100), VariableUnitsAbbreviation) AS AltUnits, 3 AS networkId
FROM         dbo.odm_uv_variables AS vars
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      ...
      End
   End
End', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'hiscentral_uv_variables';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'hiscentral_uv_variables';
